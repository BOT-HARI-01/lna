            ...
            <div className={Styles.header}>
                <nav className={Styles.navList}>
                    ...
                    <ul className={Styles.rightNav}>
                        ...
                        {/* <li><Link href='/features' className={activeLnk === 'features' && status === 1 ? Styles.active : ''} onClick={() => handleActive('features')}>Features</Link></li> */}
                        {status === 0 ? (
                            <>
                            ...
                            <>
                                <li><Link href='/profile' className={activeLnk === 'profile' ? Styles.active : ''} onClick={()=> handleActive('profile')}>Profile</Link></li>
